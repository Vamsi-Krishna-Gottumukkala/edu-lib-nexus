...
export const adminNav: NavItem[] = [
  { title: "Dashboard", url: "/admin", icon: LayoutDashboard },
  {
    title: "Gate Register", icon: DoorOpen, children: [
      { title: "RFID System", icon: Wifi, children: [
        { title: "Live Dashboard",  url: "/admin/daily-attendance",  icon: LayoutDashboard },
        { title: "RFID Logs",       url: "/admin/rfid-logs",         icon: List },
        { title: "Manage RFID",     url: "/admin/manage-rfid",       icon: Wifi },
  ...
  },
  {
    title: "System", icon: Settings, children: [
      { title: "User Management", icon: Users, children: [
        { title: "Manage Students",    url: "/admin/manage-students",    icon: UserPlus },
        { title: "Manage Faculty",     url: "/admin/manage-faculty",     icon: UserPlus },
        { title: "Registered Users",   url: "/admin/registered-users",   icon: Users },
      ]},
      { title: "Administration", icon: Settings, children: [
        { title: "Manage Programs",    url: "/admin/manage-programs",    icon: RefreshCw },
        { title: "Manage Departments", url: "/admin/manage-departments", icon: Building2 },
